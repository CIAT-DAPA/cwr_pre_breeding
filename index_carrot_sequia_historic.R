...
index_carrot_drought_historic <- function(continent = "Europa"){
  output <- paste0(root, "/CWR_pre-breeding/Results/Carrot/Index_drought/Carrot_index_drought_", tolower(continent), ".rds")
...
system.time(index_carrot_drought_historic(continent = "Africa"))
