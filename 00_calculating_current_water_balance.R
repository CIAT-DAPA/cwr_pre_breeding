...
calc_wat_bal <- function(continent = "Europa", ncores = 15){
  ...
  if(!file.exists(paste0(root, "/CWR_pre-breeding/Input_data/_soils/Water_balance/watbal_", tolower(continent), ".rds"))){
    ...
    cat(">>> Water balance for: ", continent, " has been already calculated ...\n")
