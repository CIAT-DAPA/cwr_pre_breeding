...
CarrotIndices <- function(continent = "Oceania", ncores = 15){
  
  output <- paste0(root, "/CWR_pre-breeding/Results/Carrot/Crop_indices/carrot_crop_indices_", tolower(continent), ".rds")
