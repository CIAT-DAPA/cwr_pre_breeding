...
sunflowerIndices <- function(continent = "Oceania", ncores = 15){
  
  output <- paste0(root, "/CWR_pre-breeding/Results/Sunflower/Crop_indices/sunflower_crop_indices_", tolower(continent), ".rds")
