...
index_eggplant <- function(continent = "Oceania", ncores = 10 ){
  ...
  output <- paste0(root, "/CWR_pre-breeding/Results/Eggplant/Index_drought/Eggplant_index_drought_", tolower(continent), ".rds")
...
system.time(index_eggplant(continent = "Oceania"))
