...
index_finger_millet_future <- function(continent = "Europa", rcp = "rcp45" ,gcm= "gcm1",ncores=20){
  ...
  output <- paste0(root, "/CWR_pre-breeding/Results/Finger_millet/_future/",rcp,"/",gcm,"/Crop_index/Finger_millet_index_drought_", tolower(continent), ".rds")
